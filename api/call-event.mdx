...
| `actionCallToggleHold` | `...ACTION_CALL_TOGGLE_HOLD` | iOS only | The user toggled the hold state from the CallKit UI. |
| `actionCallToggleMute` | `...ACTION_CALL_TOGGLE_MUTE` | iOS only | The user toggled the mute state from the CallKit UI. |
